      ...
      <div className="max-w-content mx-auto px-6 lg:px-8">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="flex items-start mb-4">
                <div className="flex text-[#CAFF00]">
                  {[...Array(5)].map((_, i) => (
              ...
              <div className="border-t pt-4">
                ...
                <div className="text-sm font-medium text-[#0A0A0A]">{testimonial.venue}</div>
              </div>
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <div className="flex flex-col items-center">
            <div className="w-12 h-12 bg-[#CAFF00] rounded-full flex items-center justify-center mb-3">
