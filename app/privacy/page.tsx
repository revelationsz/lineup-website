  ...
  return (
    ...
    <div className="relative z-10 max-w-4xl mx-auto space-y-8 pt-24 px-6 pb-24">
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">3. How We Use Your Information</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">4. Sharing Your Information</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">5. Data Retention</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">6. Data Security</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">7. Your Rights</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">8. Third-Party Services</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">9. Children&apos;s Privacy</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">10. Changes to Privacy Policy</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">11. Contact</h2>
          <p className="text-gray-300 leading-relaxed">
            If you have questions about this Privacy Policy, contact us at{" "}
            <a href="mailto:lineup.barapp@gmail.com" className="text-[#8B5CF6] hover:text-[#8B5CF6]/80 transition-colors underline">
