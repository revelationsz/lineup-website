  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pt-24 px-6">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-6xl md:text-7xl font-bold text-[#CAFF00]">Privacy Policy</h1>
      ...
      <div className="space-y-8">
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">1. Introduction</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">2. Information We Collect</h2>
          <p className="text-gray-300 leading-relaxed mb-4">We may collect the following information:</p>
          <ul className="space-y-3">
            <li className="flex items-start gap-3 text-gray-300">
              <div className="w-2 h-2 bg-[#CAFF00] rounded-full mt-2 flex-shrink-0"></div>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">3. How We Use Your Information</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">4. Sharing Your Information</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">5. Data Retention</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">6. Data Security</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">7. Your Rights</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">8. Third-Party Services</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">9. Children&apos;s Privacy</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">10. Changes to Privacy Policy</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-card">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">11. Contact</h2>
          <p className="text-gray-300 leading-relaxed">
            If you have questions about this Privacy Policy, contact us at{" "}
            <a href="mailto:lineup.barapp@gmail.com" className="text-[#CAFF00] hover:text-[#CAFF00]/80 transition-colors underline">
      ...
      <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 md:p-12 rounded-card text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-[#CAFF00] mb-4">Privacy Questions?</h2>
