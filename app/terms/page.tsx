  ...
  return (
    ...
    <div className="relative z-10 max-w-4xl mx-auto space-y-8 pt-24 px-6 pb-24">
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">5. Prohibited Conduct</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">6. Intellectual Property</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">7. Disclaimer of Warranties</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">8. Limitation of Liability</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">9. Termination</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">10. Governing Law</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">11. Changes to Terms</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#8B5CF6] mb-4">12. Contact</h2>
          <p className="text-gray-300 leading-relaxed">
