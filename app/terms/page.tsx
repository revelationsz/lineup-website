  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pt-24 px-6">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-6xl md:text-7xl font-bold text-[#CAFF00]">Terms of Service</h1>
      ...
      <div className="space-y-8">
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">1. Acceptance of Terms</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">2. Description of Service</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">3. Eligibility</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">4. User Accounts</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">5. Prohibited Conduct</h2>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">6. Intellectual Property</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">7. Disclaimer of Warranties</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">8. Limitation of Liability</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">9. Termination</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">10. Governing Law</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">11. Changes to Terms</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 rounded-2xl">
          <h2 className="text-2xl font-bold text-[#CAFF00] mb-4">12. Contact</h2>
          <p className="text-gray-300 leading-relaxed">
      ...
      <div className="bg-white/5 border border-white/10 backdrop-blur-sm p-8 md:p-12 rounded-3xl text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-[#CAFF00] mb-4">Questions about our Terms?</h2>
